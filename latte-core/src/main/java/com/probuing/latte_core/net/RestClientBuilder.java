...
public class RestClientBuilder {
    ...
    public final RestClientBuilder dir(String downDir) {
        this.mDownloadDir = downDir;
        return this;
    }
    ...
    public final RestClientBuilder downName(String downName) {
        this.mDownName = downName;
        return this;
    }
